...
wget --quiet -O - https://storage.googleapis.com/gcp-public-data--gnomad/release/3.0.1/coverage/genomes/gnomad.genomes.r3.0.1.coverage.summary.tsv.bgz \
    | bgzip -d \
    ...
    | bgzip -c > grch38.gnomad.v3.1.1.genome.coverage.summary.bed.gz

tabix grch38.gnomad.v3.1.1.genome.coverage.summary.bed.gz
