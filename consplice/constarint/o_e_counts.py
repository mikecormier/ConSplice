...
def o_e_counts(parser, args):
    ...
    for i,tx_key in enumerate(transcript_region_dict.keys()):
        ...
        if i % 500 == 0:
            print("\t- Processed {} transcript".format(i))
            output_log("\n\t- Processed {} transcript".format(i),out_log_file)
...
#                        sys.exit(1)
                    ...
                    if prev_pos == spliceai_var.POS:
                        ...
                        new_region = {"chrom":chrom, "start":min_region_start, "end":max_region_start}
                        new_region_key = "{}:{}-{}".format(chrom,min_region_start,max_region_start)
                        if new_region_key not in in_region_list:
                            spliceai_region_list.append(new_region)
                            in_region_list.add(new_region_key)
    ...
    output_log("\n\t- Processed {} transcript".format(i + 1),out_log_file)
